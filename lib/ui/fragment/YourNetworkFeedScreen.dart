...
class YourNetworkFeedScreen extends StatefulWidget {
  const YourNetworkFeedScreen({Key key}) : super(key: key);

  @override
  _YourNetworkFeedScreenState createState() => _YourNetworkFeedScreenState();
}

class _YourNetworkFeedScreenState extends State<YourNetworkFeedScreen>
