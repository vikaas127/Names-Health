...
import '../PostAllComments.dart';

class PrivateFeedScreen extends StatefulWidget {
  const PrivateFeedScreen({Key key}) : super(key: key);

  @override
  _PrivateFeedScreenState createState() => _PrivateFeedScreenState();
}
...
class _PrivateFeedScreenState extends State<PrivateFeedScreen>
  ...
  getSearchData() {
    ...
    if (search.isEmpty) {
      AppHelper.showToastMessage("Please enter keyword to search");
    }else{
      Map<String, String> body = Map();
      body['save_as'] = "1"; //1 = private
