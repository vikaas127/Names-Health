...
class ChatDeletePopup {
  ...
  void show(bool isBlock, BuildContext context, GlobalKey globalKey,
      Function(dynamic menuValue) clickCallback, bool fromGroup) {
    ...
    return GestureDetector(
      ...
      onTap: () {
        if (widget.clickCallback != null) {
          print("widget.menuValue===" + widget.menuValue.toString());
